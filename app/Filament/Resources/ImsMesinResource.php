...
use App\Filament\Resources\ImsMesinResource\Pages;
use App\Models\Ims;
use Filament\Forms;
...
class ImsMesinResource extends Resource
{
    protected static ?string $model = Ims::class;

    protected static ?string $navigationIcon = 'heroicon-o-cog-6-tooth';
    
    protected static ?string $label = 'IMS Mesin';
    protected static ?string $pluralLabel = 'IMS Mesin';
    protected static ?string $navigationGroup = 'QR Code IMS';
    protected static ?int $navigationSort = 2;

    // Only show records for mesin role
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('role_type', 'mesin');
    }
                ...
                Forms\Components\TextInput::make('nomor_urut')
                    ...
                    ->unique(
                        ...
                        modifyRuleUsing: function (\Illuminate\Validation\Rules\Unique $rule) {
                            return $rule->where('role_type', 'mesin');
                        }
                    ),
                    ...
                    ->content(function ($record) {
                        if ($record && $record->qr_code) {
                            return new \Illuminate\Support\HtmlString(
                                ...
                                . '<p class="text-blue-600"><strong>Role:</strong> Mesin</p>'
                                . '<p class="text-blue-600"><strong>Nomor Urut:</strong> ' . $record->nomor_urut . '</p>'
                                . '</div></div>'
                            );
                        }
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('downloadQR')
                    ...
                    ->action(function ($record) {
                        ...
                        $fileName = 'qr-ims-mesin-' . $record->nomor_urut . '.svg';
    ...
    {
        return [
            'index' => Pages\ListImsMesin::route('/'),
            'create' => Pages\CreateImsMesin::route('/create'),
            'view' => Pages\ViewImsMesin::route('/{record}'),
            'edit' => Pages\EditImsMesin::route('/{record}/edit'),
        ];
    }
}