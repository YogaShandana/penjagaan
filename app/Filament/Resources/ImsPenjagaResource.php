...
use App\Filament\Resources\ImsPenjagaResource\Pages;
use App\Models\Ims;
use Filament\Forms;
...
class ImsPenjagaResource extends Resource
{
    protected static ?string $model = Ims::class;

    protected static ?string $navigationIcon = 'heroicon-o-user-circle';
    
    protected static ?string $label = 'IMS Penjaga';
    protected static ?string $pluralLabel = 'IMS Penjaga';
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('downloadQR')
                    ...
                    ->action(function ($record) {
                        ...
                        $fileName = 'qr-ims-penjaga-' . $record->nomor_urut . '.svg';
    ...
    {
        return [
            'index' => Pages\ListImsPenjaga::route('/'),
            'create' => Pages\CreateImsPenjaga::route('/create'),
            'view' => Pages\ViewImsPenjaga::route('/{record}'),
            'edit' => Pages\EditImsPenjaga::route('/{record}/edit'),
        ];
    }
}