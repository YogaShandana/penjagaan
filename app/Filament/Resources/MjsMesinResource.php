...
use App\Filament\Resources\MjsMesinResource\Pages;
use App\Models\Mjs;
use Filament\Forms;
...
class MjsMesinResource extends Resource
{
    protected static ?string $model = Mjs::class;

    protected static ?string $navigationIcon = 'heroicon-o-cog-6-tooth';
    
    protected static ?string $label = 'MJS Mesin';
    protected static ?string $pluralLabel = 'MJS Mesin';
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('downloadQR')
                    ...
                    ->action(function ($record) {
                        ...
                        $fileName = 'qr-mjs-mesin-' . $record->nomor_urut . '.svg';
    ...
    {
        return [
            'index' => Pages\ListMjsMesin::route('/'),
            'create' => Pages\CreateMjsMesin::route('/create'),
            'view' => Pages\ViewMjsMesin::route('/{record}'),
            'edit' => Pages\EditMjsMesin::route('/{record}/edit'),
        ];
    }
}