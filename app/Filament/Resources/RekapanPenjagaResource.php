...
use App\Filament\Resources\RekapanPenjagaResource\Pages;
...
class RekapanPenjagaResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Rekapan Penjaga';

    protected static ?string $modelLabel = 'Rekapan Penjaga';

    protected static ?string $pluralModelLabel = 'Rekapan Penjaga';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->emptyStateHeading('Belum Ada Data Scan Penjaga')
            ->emptyStateDescription('Data scan QR Code area penjaga akan muncul di sini setelah ada yang melakukan scan.')
    ...
    {
        $filename = 'rekapan_penjaga_' . now()->format('Y-m-d_H-i-s') . '.csv';
    ...
    {
        return [
            'index' => Pages\ListRekapanPenjagas::route('/'),
            'create' => Pages\CreateRekapanPenjaga::route('/create'),
            'view' => Pages\ViewRekapanPenjaga::route('/{record}'),
            'edit' => Pages\EditRekapanPenjaga::route('/{record}/edit'),
        ];
    }
}