...
class ScanQr extends Page
{
    ...
    protected static string $view = 'filament.resources.scan-resource.pages.scan-qr';
    ...
    private function scanIms($cleanToken)
    {
        ...
        if ($mjs) {
            ...
            // Show error notification untuk wrong type
            Notification::make()
